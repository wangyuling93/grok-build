...
pub use ghostty_catalog::{GHOSTTY_SCHEMES, GhosttyScheme};
...
impl Theme {
    ...
    pub fn current() -> Self {
        ...
        // Auto is resolved to a concrete theme before being stored; if reached, `to_theme` falls back to GrokNight
        let base = kind.to_theme();
    ...
    /// Named/Reset without a design RGB fall back to "dark" (the default theme polarity).
