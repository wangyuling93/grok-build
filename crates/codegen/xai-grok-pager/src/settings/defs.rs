...
// Canonical names MUST match `ThemeKind::display_name()`. The catalogs are
// shared by `theme`, `auto_dark_theme`, and `auto_light_theme`; the auto-*
// sub-pickers drop "auto" to avoid a circular reference.
// ---------------------------------------------------------------------------
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            kind: SettingKind::Bool {
                default: ui_default.transparent_background_enabled(),
            },
            restart_required: false,
