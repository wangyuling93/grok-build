...
impl QueuePane {
    ...
    pub fn render(
        ...
        // Rebuild list chrome each frame so theme/transparency changes apply.
        // `selection_bg` is captured from the theme's `bg_highlight`; without
        // this it would keep the theme active at construction (default
        // GrokNight, dark) after the user switches — painting a dark band on
        // a light GrokDay canvas.
